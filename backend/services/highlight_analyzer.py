"""Analyze transcription to find interesting segments using DeepSeek."""
import logging
...
class HighlightAnalyzer:
    ...
    def analyze_segments(
        ...
        """
        max_parallel = max_parallel or config.HIGHLIGHT_CONCURRENT_REQUESTS
        try:
...
{{
  ...
  "humor": 0.0-1.0
        ...
        try:
            scores = self.client.chat_json(
                [
                    {
                        "role": "system",
                        "content": "You are an editorial AI that scores short video hooks.",
                    },
                    {
                        "role": "user",
                        "content": prompt,
