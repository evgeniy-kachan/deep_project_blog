...
def _run_analysis_pipeline(task_id: str, video_id: str, video_path: str):
    ...
    for i, segment in enumerate(filtered_highlights):
        ...
        segment['text_ru'] = translation.get('screen_text', '')
        segment['text_ru_tts'] = translation.get('tts_markup') or segment['text_ru']
        segment['subtitle_lines'] = translation.get('subtitle_lines', [segment['text_ru']])
    ...
    try:
        ...
        for segment in segments_to_process:
            ...
            final_clip = renderer.create_vertical_video(
                ...
                subtitle_lines=segment.get('subtitle_lines'),
            )
